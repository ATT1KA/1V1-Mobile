...
struct OnlineSharingView_Previews: PreviewProvider {
    static var previews: some View {
        OnlineSharingView(profile: UserProfile(
            ...
            avatarUrl: nil,
            stats: UserStats(wins: 150, losses: 50, draws: 0, totalGames: 200, winRate: 0.75, averageScore: 0, bestScore: 0, totalPlayTime: 0, favoriteGame: nil, rank: "Gold", experience: 0, level: 25),
            card: UserCard(id: UUID().uuidString, userId: "preview-user", cardName: "Preview Card", cardDescription: "A preview card", cardImage: nil, rarity: .epic, power: 120, createdAt: Date(), isActive: true),
            achievements: [
                Achievement(id: UUID().uuidString, user_id: "preview-user", achievement_id: "first_win", title: "First Win", description: "Win your first game", icon: "trophy.fill", unlocked_at: Date(), rarity: nil),
                Achievement(id: UUID().uuidString, user_id: "preview-user", achievement_id: "level_10", title: "Level 10", description: "Reach level 10", icon: "star.fill", unlocked_at: Date(), rarity: nil)
            ],
            createdAt: Date(),
            updatedAt: Date()
        ))
