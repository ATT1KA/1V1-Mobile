...
struct UserStats: Codable {
    ...
    var bestScore: Int
    var totalPlayTime: Int // in minutes
    ...
    init(wins: Int = 0, losses: Int = 0, draws: Int = 0, totalGames: Int = 0, winRate: Double = 0.0, averageScore: Double = 0.0, bestScore: Int = 0, totalPlayTime: Int = 0, favoriteGame: String? = nil, rank: String? = "Bronze", experience: Int = 0, level: Int = 1) {
        self.wins = wins
        self.losses = losses
        self.draws = draws
