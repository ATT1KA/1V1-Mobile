...
struct OnboardingData {
    ...
    func generateStats() -> UserStats {
        ...
        let playTimeMinutes = playTime.rawValue.count * 60
    ...
    func generateCardData() -> (name: String, description: String, rarity: CardRarity) {
        let cardName = cardName.isEmpty ? generateCardName() : cardName
        let cardDescription = cardDescription.isEmpty ? generateCardDescription() : cardDescription
        
        return (cardName, cardDescription, selectedRarity)
    }
